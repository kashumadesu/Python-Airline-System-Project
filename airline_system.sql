...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2025 at 02:31 PM
...
INSERT INTO `crew` (`crew_id`, `name`, `role`, `status`) VALUES
(1, 'Capt. Ri', 'Pilot', 'Available'),
(2, 'Sarah Lin', 'Cabin Crew', 'Available');
...
INSERT INTO `flights` (`flight_id`, `flight_number`, `origin`, `destination`, `flight_date`, `status`, `aircraft_id`) VALUES
(1, 'PR101', 'Manila', 'Cebu', '2025-12-25', 'Scheduled', 1);
...
(1, 'Juan Cruz', 'juan@email.com', NULL, 500, 'Silver'),
