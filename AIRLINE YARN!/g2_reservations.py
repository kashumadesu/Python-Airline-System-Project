...
def menu():
    while True:
        ...
        print("2. View My Bookings")  # <--- NEW FEATURE
...
def book_ticket():
    ...
    try:
        fid = input("\nEnter Flight ID: ")
        seat_class = input("Class (Economy/Business): ").title()
        price = 5000 if seat_class == "Economy" else 15000
        seat = input(f"Select Seat (e.g. 12A): ")
...
def view_my_bookings():
    ...
    # Join Tables to get readable info
    query = """
